...
## Corpus Check
- 105 files · ~90,606 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 685 nodes · 1136 edges · 65 communities (45 shown, 20 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 2 edges (avg confidence: 0.78)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `b8e5507f`
...
- [[_COMMUNITY_SearchResults.jsx|SearchResults.jsx]]
- [[_COMMUNITY_Saathi.jsx|Saathi.jsx]]
- [[_COMMUNITY_SaathiProfile.jsx|SaathiProfile.jsx]]
- [[_COMMUNITY_compilerOptions|compilerOptions]]
- [[_COMMUNITY_SignIn.jsx|SignIn.jsx]]
- [[_COMMUNITY_NewsletterInline.jsx|NewsletterInline.jsx]]
- [[_COMMUNITY_RecentlyViewedRail.jsx|RecentlyViewedRail.jsx]]
- [[_COMMUNITY_PriceHistoryChart.jsx|PriceHistoryChart.jsx]]
...
6. `cleanName()` - 8 edges
7. `formatNumber()` - 8 edges
8. `api` - 7 edges
9. `SearchProductCard()` - 7 edges
10. `deliveryText()` - 7 edges
...
Cohesion: 0.10
Nodes (18): fireBeacon(), getAnonId(), metaPixelPageView(), trackClick(), trackPageView(), trackSuggestClick(), trackView(), affiliateUrl() (+10 more)

### Community 7 - "Home.jsx"
Cohesion: 0.12
Nodes (14): getMostSellers(), getShowcase(), subscribeNewsletter(), defaultMarkers, GlobeAnalytics(), GlobeAnalyticsProps, PriceDropMarker, WovenLightHero() (+6 more)
...
### Community 9 - "api.js"
Cohesion: 0.14
Nodes (8): getProduct(), protectAssess(), protectConfirmOrder(), protectCreateOrder(), protectDisputeOrder(), protectGetOrder(), submitFeedback(), PAYMENTS
...
Cohesion: 0.13
Nodes (11): forgotPassword(), getAuthConfig(), getAuthToken(), getMe(), googleLogin(), resetPassword(), saathiPublicProfile(), setAuthToken() (+3 more)
...
Cohesion: 0.18
Nodes (14): getDailyPriceHistory(), getProductHistory(), getSellerTrust(), addToWishlist(), FeedbackPulse(), ProductSEO(), fmt(), SearchProductCard() (+6 more)
...
Cohesion: 0.17
Nodes (7): getDashboardStats(), getHotDrops(), getLiveStats(), getTrendingSearches(), LiveActivityPill(), Dashboard(), fmt()
...
Cohesion: 0.24
Nodes (8): verifyEmail(), useAuth(), ExitIntentModal(), Navbar(), SaathiDashboard(), SignIn(), SignUp(), VerifyEmail()

### Community 41 - "Navbar.jsx"
Cohesion: 0.29
Nodes (4): AlphaBadge(), BottomNav(), tabs, Footer()
...
### Community 57 - "SearchResults.jsx"
Cohesion: 0.19
Nodes (9): getAllProducts(), getCategories(), getShopTrust(), SearchProductCardSkeleton(), ServiceUnavailable(), sortOptions, filterOptions, SearchResults() (+1 more)
...
Cohesion: 0.23
Nodes (8): passwordLogin(), signup(), AuthLayout(), Field(), Stagger(), GoogleSignInButton(), MEMBER_BENEFITS, SignupGate()

### Community 63 - "NewsletterInline.jsx"
Cohesion: 0.16
Nodes (9): getHeadlineStats(), DropCard(), fmt(), NewsletterInline(), formatPrice(), gradientByCategory, ProductCard(), CategoryIcon (+1 more)

### Community 65 - "RecentlyViewedRail.jsx"
Cohesion: 0.36
Nodes (4): getProductsByIds(), clearRecent(), getRecentIds(), pushRecent()

### Community 66 - "PriceHistoryChart.jsx"
Cohesion: 0.39
Nodes (6): dateKey(), displayDate(), formatPrice(), PriceHistoryChart(), PriceTooltip(), ranges

## Knowledge Gaps
- **162 isolated node(s):** `check-gstack.sh script`, `$schema`, `style`, `rsc`, `tsx` (+157 more)
...
- **Why does `useAuth()` connect `SignIn.jsx` to `SaathiDashboard.jsx`, `ScrollToTop.jsx`, `Home.jsx`, `auth.js`, `auth.js`, `AdminIndexer.jsx`, `ReviewsPanel.jsx`, `RecentlyViewedRail.jsx`, `Saathi.jsx`, `SignIn.jsx`?**
